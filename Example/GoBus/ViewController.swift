...
class ViewController: UIViewController, GoBusDelegate {
    ...
    override func viewDidLoad() {
        ...
        //GoBus().getLines(search: <#T##String?#>, completion: <#T##(([Line]?, NSError?) -> Void)##(([Line]?, NSError?) -> Void)##([Line]?, NSError?) -> Void#>)
        ...
        //GoBus().getStops(search: <#T##String?#>, completion: <#T##(([Stop]?, NSError?) -> Void)##(([Stop]?, NSError?) -> Void)##([Stop]?, NSError?) -> Void#>)
